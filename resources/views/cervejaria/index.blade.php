...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <br>
    <h1 style="margin-left:10%">lista de produtos</h1>
                ...
                @endphp
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $cerveja->descricao}}</p>
                            <a href="{{route('cervejaria.show',$cerveja->id)}}" class="btn btn-primary">Comprar: R${{$cerveja->preco}},00</a>
                        </div>
                        </div>
                    </div>
